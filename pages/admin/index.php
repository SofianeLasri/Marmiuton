...
<body>
	...
	<div class="dashboardTopCard" leftSidebar="240" rightSidebar="0">
		<div class="d-flex">
			...
			<div class="ml-5">
				...
				<strong>Je tiens à préciser que cette partie du site a été réalisée de manière totalement déloyale. :)</strong></p>
			</div>
		</div>
	</div>
	<div class="page-content notTop" leftSidebar="240" rightSidebar="0">
		...
		<p>Cette page d'acceuil est décidément condamnée à être vide. On a clairement pas le temp de développer. 
